...
🛠️ **In simple terms:**  
You can easily edit your site’s code in a formatted, human-readable form inside `src/index.html` and get optimised site files in seconds.<br>
...
[![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-light-grey.svg)](https://creativecommons.org/licenses/by-nc/4.0/)

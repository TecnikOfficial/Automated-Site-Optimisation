...
🛠️ **In simple terms:**  
Click on [![Use this Template](https://img.shields.io/badge/1.0-green.svg)](https://github.com/new?template_name=Automated-Site-Optimiser&template_owner=TecnikOfficial) button and make necessary changes easily `src/index.html` and get optimised site files in seconds.<br>
